    ...
    <div className="container mt-2">
      <div className="">
        <div className="row align-items-center mb-3">
          ...
          <div className="col-12 col-md-4 order-1 order-md-3 text-center text-md-end mb-3 mb-md-0">
            <h2 className="mb-3" style={{ color: "#034694" }}>Manage Tool Details</h2>
          </div>

          {/* Dropdown for filtering by Machine ID */}
          {/* <div className="col-12 col-md-4 order-2 mb-3 mb-md-0">
            <select
              value={searchMachineId}
              onChange={handleMachineFilterChange}
              className="form-control"
            >
              <option value="">Search By Machine ID</option>
              {machineIds.map((id) => (
      ...
      {!showForm && (
        <form onSubmit={handleSubmit}>
          ...
          <button
            type="button"
            className="btn btn-secondary me-3 ml-2"
            onClick={() => {
              resetForm();
              setShowForm(false);
            }}
