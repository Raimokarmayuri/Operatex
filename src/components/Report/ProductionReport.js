...
//           <button className="btn btn-primary mt-4 fs-4" onClick={exportToExcel}>
//             Export to Excel
//           </button>
//         </div>
//       </div>
...
//       >
//       <table
//         className="table table-bordered table-hover mt-4 ms-3"
//         style={{
...
//               <th style={{ color: "#034694" }} colSpan="3">OEE (%)</th>
//               <th style={{ color: "#034694" }} colSpan="3">Actual Production Data</th>{" "}
//               {/* Merging OEE, Actual Production Qty, and Standard Production Qty into one group */}
//               <th style={{ color: "#034694" }} colSpan="3">Standard Production Data</th>
//               <th style={{ color: "#034694" }} colSpan="3">Downtime (hr)</th>
//               <th style={{ color: "#034694" }} colSpan="3">Defect Part</th>
//               <th style={{ color: "#034694" }} colSpan="3">Availability (%)</th>
//               <th style={{ color: "#034694" }} colSpan="3">Quality (%)</th>
//               <th style={{ color: "#034694" }} colSpan="3">Defect Part</th>
